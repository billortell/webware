...
<tr>
  <td>
    ...
    <div id="summary_auto_box" class="hideifnojs">
      ...
      <div class="entry_edit_left entry_edit_info">
        <div id="summary_auto_title">
          ...
          <span id="summary_media_box" class="hideifnojs"><a href="javascript:;"  onclick="current_media_plugin = 'summary'; openWindow('/hssui/editor-plugin-upload/?target=summary', 'upload', '800', '600')">[Insert Images]</a></span>
        </div>
      </div>
    ...
    <div class="entry_edit_left entry_edit_info">
      ...
      <span id="content_media_box" class="hideifnojs"><a href="javascript:;"  onclick="current_media_plugin = 'content'; openWindow('/hssui/editor-plugin-upload/?target=content', 'upload', '800', '600')">[Insert Images]</a></span>
    </div>
