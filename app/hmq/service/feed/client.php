...
/**
 * Class hmq_service_feed_client
 *
 * Example: GET
 *  $client = new hmq_service_feed_client('http://www.example.com/ws/?var=value');
 *  if ($client->doGet() == 200) {
 *      $response = $client->getBody();
 *  }
 *
 * Example: POST/PUT
 *  $client = new hmq_service_feed_client('http://www.example.com/ws/');
...
class hmq_service_feed_client
{
    ...
    protected function _conn($uri = NULL)
    {
        ...
        curl_setopt($this->_conn, CURLOPT_USERAGENT, 'HMQ 1.0.0');
